...
import (
	...
	dbackupk8sv1alpha1 "k8s.io/dbackupk8s/pkg/apis/dbackupk8s/v1alpha1"
	versioned "k8s.io/dbackupk8s/pkg/generated/clientset/versioned"
	internalinterfaces "k8s.io/dbackupk8s/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "k8s.io/dbackupk8s/pkg/generated/listers/dbackupk8s/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Dbackupk8sV1alpha1().Databases(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Dbackupk8sV1alpha1().Databases(namespace).Watch(context.TODO(), options)
			},
		},
		&dbackupk8sv1alpha1.Database{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *databaseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dbackupk8sv1alpha1.Database{}, f.defaultInformer)
}
