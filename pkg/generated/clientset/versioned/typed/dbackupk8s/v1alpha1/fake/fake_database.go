...
type FakeDatabases struct {
	Fake *FakeDbackupk8sV1alpha1
	ns   string
}

var databasesResource = schema.GroupVersionResource{Group: "dbackupk8s.k8s.io", Version: "v1alpha1", Resource: "databases"}

var databasesKind = schema.GroupVersionKind{Group: "dbackupk8s.k8s.io", Version: "v1alpha1", Kind: "Database"}
