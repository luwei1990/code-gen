...
var foosResource = schema.GroupVersionResource{Group: "dbackupk8s.k8s.io", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "dbackupk8s.k8s.io", Version: "v1alpha1", Kind: "Foo"}
